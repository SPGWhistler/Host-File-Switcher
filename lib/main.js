 ...
 * @TODO Add ability to have a "always add this data" thing in prefs that
 * always gets added no matter what. (Although technically, this is not
 * needed because it could be accomplished through the regular way.)
