...
var hostFileSwitcher = {
	...
	syncHostFiles : function()
	{
		...
		*/
		...
		haystack = escape(this.tmpSystemHostFileContents).replace(/%0D/g, ''); //@TODO Figure out what this character means - this will be a problem on other oses.
		var patt;
		var needle;
		for (var i in storage.storage.hostFiles)
		{
			//@TODO what about an empty system host file?
			needle = escape(storage.storage.hostFiles[i].data);
